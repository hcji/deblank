...
RcppExport SEXP _deblank_getPIP(SEXP seedsSEXP, SEXP scansSEXP, SEXP mzsSEXP, SEXP cluSEXP, SEXP mztolSEXP, SEXP gapSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _deblank_waveft(SEXP omegaSEXP, SEXP scalesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _deblank_cwtft(SEXP valSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _deblank_localMax(SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _deblank_localMin(SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
RcppExport SEXP _deblank_ridgesDetection(SEXP cwt2dSEXP, SEXP valSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
RcppExport SEXP _deblank_peaksPosition(SEXP valSEXP, SEXP ridgesSEXP, SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type val(valSEXP);
...
RcppExport SEXP _deblank_getSignal(SEXP cwt2dSEXP, SEXP ridgesSEXP, SEXP peaksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_deblank_getPIP", (DL_FUNC) &_deblank_getPIP, 6},
    {"_deblank_waveft", (DL_FUNC) &_deblank_waveft, 2},
    {"_deblank_cwtft", (DL_FUNC) &_deblank_cwtft, 1},
    {"_deblank_localMax", (DL_FUNC) &_deblank_localMax, 1},
    {"_deblank_localMin", (DL_FUNC) &_deblank_localMin, 1},
    {"_deblank_ridgesDetection", (DL_FUNC) &_deblank_ridgesDetection, 2},
    {"_deblank_peaksPosition", (DL_FUNC) &_deblank_peaksPosition, 3},
    {"_deblank_getSignal", (DL_FUNC) &_deblank_getSignal, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_deblank(DllInfo *dll) {
